...
#let conf(
  ...
  // Figure for the institution. Can be omitted if you don't have one.
  institution-figure: none,

  // Text to display below the institution figure (e.g., faculty name).
  institution-figure-caption: none,
  ...
  // Acknowledgements for your work. Can be omitted if you don't have one.
  ...
  page(
    align(
      ...
      block(width: 100%)[
        ...
        #if institution != none {
          text(size: 1.2em, smallcaps(institution))
          v(1.5cm)
        }

        // Horizontal rule
        #line(length: 100%, stroke: 0.5mm + black)
        #v(0.5cm)
        ...
        // Institution logo
        #if institution-figure != none {
          image(institution-figure, width: 110%)
        }

        #if institution-figure-caption != none {
          v(0.5cm)
          text(size: 1.6em, institution-figure-caption)
        }
        ...
        // Date at bottom
        #if date != none {
          text(size: 1.1em, date.display(date-format))
          v(3cm)
        }
      ],
    ),
  ...
  if abstract != none {
    page[
      #align(center)[
        #text(size: 1.5em, weight: "bold")[Abstract]
      ]
      #v(1.5em)
      #abstract
    ]
  ...
  // Display acknowledgements page
  if acknowledgements != none {
    page[
      #align(center)[
        #text(size: 1.5em, weight: "bold")[Acknowledgements]
      ]
      #v(1.5em)
      #acknowledgements
    ]
